...
function RootRedirect() {
  const { platformUser, tenantUser } = useAuth();
  if (platformUser) return <Navigate to="/platform/dashboard" replace />;
  if (tenantUser) return <Navigate to="/tenant/dashboard" replace />;
...
import CashFunds from '@tenant/pages/CashFunds';
import BankAccounts from '@tenant/pages/BankAccounts';
...
import ReportDebtCustomer from '@tenant/pages/ReportDebtCustomer';
import ReportDebtSupplier from '@tenant/pages/ReportDebtSupplier';
import ReportPurchaseBySupplier from '@tenant/pages/ReportPurchaseBySupplier';
import ReportSalesByCustomer from '@tenant/pages/ReportSalesByCustomer';
import ReportSalesByProduct from '@tenant/pages/ReportSalesByProduct';
  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="cash-funds" element={<CashFunds />} />
        ...
        <Route path="reports/debt-customer" element={<ReportDebtCustomer />} />
        <Route path="reports/debt-supplier"          element={<ReportDebtSupplier />} />
        <Route path="reports/purchase-by-supplier"  element={<ReportPurchaseBySupplier />} />
        <Route path="reports/sales-by-customer"     element={<ReportSalesByCustomer />} />
