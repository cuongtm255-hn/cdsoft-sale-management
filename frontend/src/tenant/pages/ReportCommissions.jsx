...
import { PlusOutlined, PrinterOutlined, ReloadOutlined, SettingOutlined } from '@ant-design/icons';
import { printReportCommissions } from '@shared/utils/printDocument';
...
function ConfigModal({ open, onClose, onSaved }) {
  ...
  return (
    <Modal
      ...
      title="Cấu hình hoa hồng" width={520} destroyOnHidden
    >
...
export default function ReportCommissions() {
  ...
  const handlePrint = () => printReportCommissions({
