...
/**
 * Tenant DB migration: adds stocktaking_sessions, stocktaking_items, inventory_lots.
 *
 * This migration must run only against tenant databases. It is applied
 * automatically by TenantDataSourceManager when a tenant datasource initializes.
 */
