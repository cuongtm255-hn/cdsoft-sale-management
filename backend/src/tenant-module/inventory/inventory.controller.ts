...
import {
  ...
  InventoryFilterDto, StockReceiptFilterDto, StockReceiptPurchaseOrderOptionFilterDto,
...
export class InventoryController {
  ...
  @Get('stock-receipts-purchase-orders')
  @ApiOperation({ summary: 'List purchase orders available for stock receipt assignment' })
  getPurchaseOrdersForReceipts(@Query() filter: StockReceiptPurchaseOrderOptionFilterDto) {
    return this.service.listPurchaseOrdersForReceipt(filter);
  }
  ...
  @Get('stock-issues-sale-orders')
  @ApiOperation({ summary: 'List sales orders available for stock issue assignment' })
  getSaleOrdersForIssues(@Query() filter: StockIssueSaleOrderOptionFilterDto) {
    return this.service.listSaleOrdersForIssue(filter);
  }
